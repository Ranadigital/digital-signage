<?php
$theme           = wp_get_theme('liquory');
$liquory_version = $theme['Version'];
...
$liquory = (object)array(
    'version' => $liquory_version,
    /**
...
if (liquory_is_woocommerce_activated()) {
    $liquory->woocommerce = require get_theme_file_path('inc/woocommerce/class-woocommerce.php');
...
if (liquory_is_elementor_activated()) {
    ...
    $liquory->elementor = require get_theme_file_path('inc/elementor/class-elementor.php');
    //====start_premium
    $liquory->megamenu = require get_theme_file_path('inc/megamenu/megamenu.php');
    //====end_premium
    $liquory->parallax = require get_theme_file_path('inc/elementor/class-section-parallax.php');
