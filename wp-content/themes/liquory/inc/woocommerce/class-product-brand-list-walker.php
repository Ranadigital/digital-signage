<?php
/**
 * Liquory_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Liquory_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Liquory_Product_Brand_List_Walker', false)) :

	class Liquory_Product_Brand_List_Walker extends Walker {
