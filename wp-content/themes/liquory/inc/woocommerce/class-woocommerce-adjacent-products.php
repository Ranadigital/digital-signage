<?php
/**
 * Liquory WooCommerce Adjacent Products Class
 *
 * @package  liquory
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Liquory_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Liquory WooCommerce Adjacent Products Class
	 */
	class Liquory_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'liquory_woocommerce_adjacent_query_args', $args ) );
