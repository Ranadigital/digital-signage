...
if (!class_exists('Liquory_WQFSP')) :
    ...
    class Liquory_WQFSP {
        ...
        /**
         * Main Liquory_WQFSP Instance
         *
         * Ensures only one instance of WooCommerce is loaded or can be loaded.
         *
         * @static
         * @return Liquory_WQFSP main instance
         * @see Liquory_WQFSP()
         */
		...
		jQuery(".added_to_cart").after("<p class=\'confirm_add\'>' . esc_html__('Item Added', '') . '</p>");
});
