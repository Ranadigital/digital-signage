...
abstract class Liquory_Base_Widgets extends Widget_Base {
    protected function add_control_for_carousel($condition = array()) {
        $this->start_controls_section(
            'section_carousel_options',
            [
                'label'     => esc_html__('Carousel Options', 'liquory'),
        ...
        $this->add_control(
            'enable_carousel',
            [
                'label' => esc_html__('Enable', 'liquory'),
        ...
        $this->add_control(
            'centerMode',
            [
                'label'     => esc_html__('Center Mode', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'no',
                'condition' => [
                    'enable_carousel' => 'yes'
        ...
        $this->add_control(
            'variableWidth',
            [
                'label'     => esc_html__('Variable Width', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'no',
                'condition' => [
                    'enable_carousel' => 'yes'
        ...
        $this->add_responsive_control(
            'centerPadding',
            [
                'label'      => esc_html__('Center Padding', 'liquory'),
        ...
        $this->add_control(
            'navigation',
            [
                'label'     => esc_html__('Navigation', 'liquory'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'dots',
                'options'   => [
                    'both'   => esc_html__('Arrows and Dots', 'liquory'),
                    'arrows' => esc_html__('Arrows', 'liquory'),
                    'dots'   => esc_html__('Dots', 'liquory'),
        ...
        $this->add_control(
            'pause_on_hover',
            [
                'label'     => esc_html__('Pause on Hover', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
        ...
        $this->add_control(
            'autoplay',
            [
                'label'     => esc_html__('Autoplay', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
        ...
        $this->add_control(
            'autoplaySpeed',
            [
                'label'     => esc_html__('Autoplay Speed', 'liquory'),
        ...
        $this->add_control(
            'infinite',
            [
                'label'     => esc_html__('Infinite Loop', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
        ...
        $this->start_controls_section(
            'carousel_arrows',
            [
                'label'      => esc_html__('Carousel Arrows', 'liquory'),
                'conditions' => [
                    'relation' => 'and',
                    'terms'    => [
                        [
        ...
        $this->add_control(
            'hover_style_arrow',
            [
                'label'        => esc_html__('Hover Arrow', 'liquory'),
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'style_arrow',
            [
                'label'        => esc_html__('Style Arrow', 'liquory'),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Border', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color background', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'next_heading',
            [
                'label' => esc_html__('Next button', 'liquory'),
                'type'  => Controls_Manager::HEADING,
            ]
        );
        ...
        $this->add_control(
            'next_vertical',
            [
                'label'       => esc_html__('Next Vertical', 'liquory'),
        ...
        $this->add_control(
            'next_horizontal',
            [
                'label'       => esc_html__('Next Horizontal', 'liquory'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'left'  => [
        ...
        $this->add_control(
            'prev_heading',
            [
                'label'     => esc_html__('Prev button', 'liquory'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before'
            ]
        );
        ...
        $this->add_control(
            'prev_vertical',
            [
                'label'       => esc_html__('Prev Vertical', 'liquory'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'top'    => [
        ...
        $this->add_control(
            'prev_horizontal',
            [
                'label'       => esc_html__('Prev Horizontal', 'liquory'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'left'  => [
        ...
        $this->start_controls_section(
            'carousel_dots',
            [
                'label'      => esc_html__('Carousel Dots', 'liquory'),
                'conditions' => [
                    'relation' => 'and',
                    'terms'    => [
                        [
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__('Activate', 'liquory'),
            ]
        );
        ...
        $this->add_responsive_control(
            'Alignment_text',
            [
                'label'     => esc_html__('Alignment text', 'liquory'),
                'type'      => Controls_Manager::CHOOSE,
                'options'   => [
                    'left'   => [
                        'title' => esc_html__('Left', 'liquory'),
    ...
    protected function get_data_elementor_columns() {
        ...
        if ($settings['enable_carousel'] === 'yes') {
            ...
            $this->add_render_attribute('row', 'class', 'liquory-carousel');
