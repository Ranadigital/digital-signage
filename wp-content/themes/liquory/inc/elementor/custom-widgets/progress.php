...
add_action('elementor/element/progress/section_progress_style/before_section_end', function ($element, $args) {
    $element->add_control(
        'bar_border_radius1',
        [
            'label'      => esc_html__('Progress Done Border Radius ', 'liquory'),
...
add_action('elementor/element/progress/section_progress_style/before_section_end', function ($element, $args) {
    $element->add_responsive_control(
        ...
        [
            'label'      => esc_html__('Progress bar padding', 'liquory'),
...
add_action('elementor/element/progress/section_title/before_section_end', function ($element, $args) {
    $element->add_control(
        ...
        [
            'label'     => esc_html__('Percentage Text', 'liquory'),
...
add_action('elementor/element/progress/section_title/before_section_end', function ($element, $args) {
    $element->add_control(
        ...
        [
            'label'     => esc_html__('Percentage Color', 'liquory'),
...
class Liquory_Elementor_Progress extends Widget_Progress {
    /**
...
$widgets_manager->register(new Liquory_Elementor_Progress());
