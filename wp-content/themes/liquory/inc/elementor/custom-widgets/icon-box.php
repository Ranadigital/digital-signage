...
add_action('elementor/element/icon-box/section_style_content/before_section_end', function ($element, $args) {
	$element->add_control(
		...
		[
			'label'     => esc_html__('Color Title Hover', 'liquory'),
...
add_action('elementor/element/icon-box/section_style_icon/before_section_end', function ($element, $args) {
    $element->add_control(
        ...
        [
            'label'     => esc_html__('Color Shape', 'liquory'),
            'type'      => Controls_Manager::COLOR,
            'default'   => '',
            'selectors' => [
...
add_action('elementor/element/icon-box/section_style_icon/before_section_end', function ($element, $args) {
    $element->add_control(
        ...
        [
            'label'     => esc_html__('Color Shape Hover', 'liquory'),
            'type'      => Controls_Manager::COLOR,
            'default'   => '',
            'selectors' => [
...
add_action('elementor/element/icon-box/section_style_icon/before_section_end', function ($element, $args) {
    $element->add_responsive_control(
        'icon_box_shape_size',
        [
            'label'     => esc_html__('Shape Size', 'liquory'),
...
add_action('elementor/element/icon-box/section_style_icon/before_section_end', function ($element, $args) {
    $element->add_responsive_control(
        ...
        [
            'label'     => esc_html__('Color Shape Top Horizontal', 'liquory'),
            'type'      => Controls_Manager::SLIDER,
            'size_units'=> ['px', 'em', '%'],
            'range' => [
                'px' => [
...
add_action('elementor/element/icon-box/section_style_icon/before_section_end', function ($element, $args) {
    $element->add_responsive_control(
        ...
        [
            'label'     => esc_html__('Color Shape Top Vertical', 'liquory'),
            'type'      => Controls_Manager::SLIDER,
            'size_units'=> ['px', 'em', '%'],
            'range' => [
                'px' => [
...
add_action('elementor/element/icon-box/section_style_icon/before_section_end', function ($element, $args) {
    $element->add_control(
        ...
        [
            'label'     => esc_html__('Icon color when hovering to block', 'liquory'),
            'type'      => Controls_Manager::COLOR,
            'default'   => '',
            'selectors' => [
...
add_action('elementor/element/icon-box/section_style_icon/before_section_end', function ($element, $args) {
    $element->add_control(
        ...
        [
            'label'     => esc_html__('Background color when hovering to block ', 'liquory'),
            'type'      => Controls_Manager::COLOR,
            'default'   => '',
            'selectors' => [
