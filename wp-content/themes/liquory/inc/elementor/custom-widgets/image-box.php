...
add_action('elementor/element/image-box/section_image/before_section_end', function ($element, $args) {
    ...
    $element->add_control(
        'image_show_button',
        [
            'label' => esc_html__('Show Button', 'liquory'),
    ...
    $element->add_control(
        ...
        [
            ...
            'label_block' => true,
            'placeholder' => esc_html__('Button', 'liquory'),
            'default'     => esc_html__('Button', 'liquory'),
            'condition'   => [
...
class Liquory_Elementor_Image_Box extends Widget_Image_Box {
...
<i class="liquory-icon-arrow_s"></i></span></a></div>');
                }
            }
...
$widgets_manager->register(new Liquory_Elementor_Image_Box());
