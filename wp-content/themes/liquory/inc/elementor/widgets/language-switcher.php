 ...
 * @since 1.0.0
 */
class Liquory_Elementor_Language_Switcher extends Elementor\Widget_Base
{
    ...
    {
        return 'liquory-language-switcher';
    }
    ...
    {
        return esc_html__('Language Switcher', 'liquory');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'typography',
                'selector' => '{{WRAPPER}} .liquory-language-switcher span.title',
            ]
        );
        ...
        $this->add_control(
            'label_color',
            [
                'label' => esc_html__('Label Color', 'liquory'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .liquory-language-switcher .item > div i' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'hover_right',
            [
                'label' => esc_html__('Hover Right', 'liquory'),
    ...
    {
        liquory_language_switcher();
    }
}

$widgets_manager->register(new Liquory_Elementor_Language_Switcher());
