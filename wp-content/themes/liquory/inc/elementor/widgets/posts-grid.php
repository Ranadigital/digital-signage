...
/**
 * Class Liquory_Elementor_Blog
 */
class Liquory_Elementor_Post_Grid extends Liquory_Base_Widgets {

    public function get_name() {
        return 'liquory-post-grid';
    }

    public function get_title() {
        return esc_html__('Posts Grid', 'liquory');
    }
    ...
    public function get_script_depends() {
        return ['liquory-elementor-posts-grid', 'slick'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_query',
            [
                'label' => esc_html__('Query', 'liquory'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'liquory'),
                    'post_title' => esc_html__('Title', 'liquory'),
        ...
        $this->add_control(
            'tag_operator',
            [
                'label'     => esc_html__('Tags Operator', 'liquory'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'IN',
                'options'   => [
                    'AND'    => esc_html__('AND', 'liquory'),
        ...
        $this->add_control(
            'layout',
            [
                'label' => esc_html__('Layout', 'liquory'),
                'type'  => Controls_Manager::HEADING,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'    => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'post-style-1' => esc_html__('Blog Style 1', 'liquory'),
                    'post-style-2' => esc_html__('Blog Style 2', 'liquory'),
                    'post-style-3' => esc_html__('Blog Style 3', 'liquory'),
                ],
        ...
        $this->add_control(
            'image_hidden',
            [
                'label'        => esc_html__('Hidden Image', 'liquory'),
        ...
        $this->add_control(
            'description_hidden',
            [
                'label'        => esc_html__('Hidden Description', 'liquory'),
                'type'         => Controls_Manager::SWITCHER,
                'selectors'  => [
        ...
        $this->add_control(
            'read_more_hidden',
            [
                'label'        => esc_html__('Hidden Read More', 'liquory'),
                'type'         => Controls_Manager::SWITCHER,
                'selectors'  => [
        ...
        $this->start_controls_section(
            'section_pagination',
            [
                'label' => esc_html__('Pagination', 'liquory'),
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'numbers'               => esc_html__('Numbers', 'liquory'),
                    'prev_next'             => esc_html__('Previous/Next', 'liquory'),
                    'numbers_and_prev_next' => esc_html__('Numbers', 'liquory') . ' + ' . esc_html__('Previous/Next', 'liquory'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Page Limit', 'liquory'),
                'default'   => '5',
                'condition' => [
                    'pagination_type!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Shorten', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => '',
                'condition' => [
                    'pagination_type' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Previous Label', 'liquory'),
                'default'   => esc_html__('&laquo; Previous', 'liquory'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Next Label', 'liquory'),
                'default'   => esc_html__('Next &raquo;', 'liquory'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
        ...
        $this->add_responsive_control(
            'title_margin',
            [
                'label'      => esc_html__('Title Margin', 'liquory'),
        ...
        $this->add_control(
            'title_color_hover',
            [
                'label'     => esc_html__('Title Color Hover', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'meta_color',
            [
                'label'     => esc_html__('Meta Color', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'meta_color_link',
            [
                'label'     => esc_html__('Mete Link Color', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Meta Link Color Hover', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_responsive_control(
            'meta_margin',
            [
                'label'      => esc_html__('Meta Margin ', 'liquory'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} [class*=layout-post-style-] .entry-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_responsive_control(
            'description_margin',
            [
                'label'      => esc_html__('Description Margin ', 'liquory'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} [class*=layout-post-style-] .entry-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_control(
            'more-link_color',
            [
                'label'     => esc_html__('Button Color', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Button Color Hover', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Border Color Hover', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_responsive_control(
            'more-link_margin',
            [
                'label'      => esc_html__('Button Margin ', 'liquory'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
    ...
    protected function render() {
        ...
        <div <?php echo liquory_elementor_get_render_attribute_string('wrapper', $this); ?>>
            <div <?php echo liquory_elementor_get_render_attribute_string('row', $this); ?>>
                <?php
    ...
    protected function render_loop_footer() {
        ...
        if ($has_numbers) {
            $links = paginate_links([
                ...
                'before_page_number' => '<span class="elementor-screen-only">' . esc_html__('Page', 'liquory') . '</span>',
            ]);
        }
        ...
        <div class="pagination">
            <nav class="elementor-pagination" role="navigation"
                 aria-label="<?php esc_attr_e('Pagination', 'liquory'); ?>">
...
$widgets_manager->register(new Liquory_Elementor_Post_Grid());
