...
class Liquory_Pricing extends Elementor\Widget_Base {

    public function get_name() {
        return 'liquory-pricing';
    }

    public function get_title() {
        return esc_html__('Liquory Pricing', 'liquory');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Enter your title', 'liquory'),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__('Enter your description', 'liquory'),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $this->start_controls_section(
            'section_pricing',
            [
                'label' => esc_html__('Pricing', 'liquory'),
            ]
        );
        ...
        $this->add_control(
            'currency_symbol',
            [
                'label'   => esc_html__('Currency Symbol', 'liquory'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    ''             => esc_html__('None', 'liquory'),
                    'dollar'       => '&#36; ' . _x('Dollar', 'Currency', 'liquory'),
                    'euro'         => '&#128; ' . _x('Euro', 'Currency', 'liquory'),
                    'baht'         => '&#3647; ' . _x('Baht', 'Currency', 'liquory'),
                    'franc'        => '&#8355; ' . _x('Franc', 'Currency', 'liquory'),
                    'guilder'      => '&fnof; ' . _x('Guilder', 'Currency', 'liquory'),
                    'krona'        => 'kr ' . _x('Krona', 'Currency', 'liquory'),
                    'lira'         => '&#8356; ' . _x('Lira', 'Currency', 'liquory'),
                    'peseta'       => '&#8359 ' . _x('Peseta', 'Currency', 'liquory'),
                    'peso'         => '&#8369; ' . _x('Peso', 'Currency', 'liquory'),
                    'pound'        => '&#163; ' . _x('Pound Sterling', 'Currency', 'liquory'),
                    'real'         => 'R$ ' . _x('Real', 'Currency', 'liquory'),
                    'ruble'        => '&#8381; ' . _x('Ruble', 'Currency', 'liquory'),
                    'rupee'        => '&#8360; ' . _x('Rupee', 'Currency', 'liquory'),
                    'indian_rupee' => '&#8377; ' . _x('Rupee (Indian)', 'Currency', 'liquory'),
                    'shekel'       => '&#8362; ' . _x('Shekel', 'Currency', 'liquory'),
                    'yen'          => '&#165; ' . _x('Yen/Yuan', 'Currency', 'liquory'),
                    'won'          => '&#8361; ' . _x('Won', 'Currency', 'liquory'),
                    'custom'       => esc_html__('Custom', 'liquory'),
                ],
                'default' => 'dollar',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Custom Symbol', 'liquory'),
                'type'      => Controls_Manager::TEXT,
                'condition' => [
        ...
        $this->add_control(
            'price',
            [
                'label'   => esc_html__('Price', 'liquory'),
                'type'    => Controls_Manager::TEXT,
                'default' => '39.99',
                'dynamic' => [
                    'active' => true,
        ...
        $this->add_control(
            'currency_format',
            [
                'label'   => esc_html__('Currency Format', 'liquory'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    ''  => '1,234.56 (Default)',
                    ',' => '1.234,56',
        ...
        $this->add_control(
            'original_price',
            [
                'label'     => esc_html__('Original Price', 'liquory'),
        ...
        $this->add_control(
            'period',
            [
                'label'   => esc_html__('Period', 'liquory'),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__('Monthly', 'liquory'),
            ]
        );
        ...
        $this->start_controls_section(
            'section_features',
            [
                'label' => esc_html__('Features', 'liquory'),
            ]
        );
        ...
        $repeater->add_control(
            'item_text',
            [
                'label'   => esc_html__('Text', 'liquory'),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__('List Item', 'liquory'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'item_text'          => esc_html__('List Item #1', 'liquory'),
                        'selected_item_icon' => $default_icon,
                    ],
                    [
                        'item_text'          => esc_html__('List Item #2', 'liquory'),
                        'selected_item_icon' => $default_icon,
                    ],
                    [
                        'item_text'          => esc_html__('List Item #3', 'liquory'),
                        'selected_item_icon' => $default_icon,
                    ],
                ],
        ...
        $this->start_controls_section(
            'section_footer',
            [
                'label' => esc_html__('Footer', 'liquory'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Additional Info', 'liquory'),
                'type'    => Controls_Manager::TEXTAREA,
                'default' => esc_html__('This is text element', 'liquory'),
                'rows'    => 3,
                'dynamic' => [
                    'active' => true,
                ],
        ...
        $this->start_controls_section(
            'section_ribbon',
            [
                'label' => esc_html__('Ribbon', 'liquory'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Title', 'liquory'),
                'type'      => Controls_Manager::TEXT,
                'default'   => esc_html__('Popular', 'liquory'),
                'condition' => [
                    'show_ribbon' => 'yes',
                ],
                'dynamic'   => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Position', 'liquory'),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'before' => [
                        'title' => esc_html__('Before', 'liquory'),
                        'icon'  => 'eicon-h-align-left',
                    ],
                    'after'  => [
                        'title' => esc_html__('After', 'liquory'),
                        'icon'  => 'eicon-h-align-right',
                    ],
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Fractional Part', 'liquory'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => false,
                'options'     => [
                    'below'  => esc_html__('Below', 'liquory'),
                    'beside' => esc_html__('Beside', 'liquory'),
                ],
                'default'     => 'below',
                'condition'   => [
                    'period!' => '',
        ...
        $this->add_control(
            'list_divider',
            [
                'label'     => esc_html__('Divider', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'separator' => 'before',
            ]
        ...
        $this->add_control(
            'divider_weight',
            [
                'label'     => esc_html__('Weight', 'liquory'),
                'type'      => Controls_Manager::SLIDER,
                'default'   => [
                    'size' => 2,
                    'unit' => 'px',
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => 'md',
                'options'   => [
                    'xs' => esc_html__('Extra Small', 'liquory'),
                    'sm' => esc_html__('Small', 'liquory'),
                    'md' => esc_html__('Medium', 'liquory'),
                    'lg' => esc_html__('Large', 'liquory'),
                    'xl' => esc_html__('Extra Large', 'liquory'),
                ],
                'condition' => [
                    'button_text!' => '',
                ],
        ...
        $this->add_control(
            'button_text_padding',
            [
                'label'      => esc_html__('Button Padding', 'liquory'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
        ...
        $this->add_responsive_control(
            'ribbon_distance',
            [
                'label'     => esc_html__('Distance', 'liquory'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
...
$widgets_manager->register(new Liquory_Pricing());
