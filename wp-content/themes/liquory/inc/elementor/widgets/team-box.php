...
class Liquory_Elementor_Team_Box extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Team Box', 'liquory');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'teams',
            [
                'label' => esc_html__('Team Item', 'liquory'),
        ...
        $repeater->add_control(
            'social_link',
            [
                'label'       => esc_html__('Social Link', 'liquory'),
                'placeholder' => esc_html__('https://www.facebook.com', 'liquory'),
        ...
        $this->add_control(
            'socials',
            [
                'label'       => esc_html__('Socials', 'liquory'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Icon Social', 'liquory'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
...
$widgets_manager->register(new Liquory_Elementor_Team_Box());
