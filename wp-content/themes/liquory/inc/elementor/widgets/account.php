...
class Liquory_Elementor_Account extends Elementor\Widget_Base {

    public function get_name() {
        return 'liquory-account';
    }

    public function get_title() {
        return esc_html__('Liquory Account', 'liquory');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    'value'   => 'liquory-icon- liquory-icon-account',
                    'library' => 'liquory',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Elementor\Group_Control_Typography::get_type(),
            [
                'label'    => esc_html__('Content Name', 'liquory'),
        ...
        $this->add_control(
            'content_color',
            [
                'label'     => esc_html__('Color Content', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'name_text_color',
            [
                'label'     => esc_html__('Color Name', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Name Hover', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
...
$widgets_manager->register(new Liquory_Elementor_Account());
