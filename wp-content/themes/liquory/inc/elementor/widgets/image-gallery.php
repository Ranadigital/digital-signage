 ...
 * @since 1.0.0
 */
class Liquory_Elementor_Image_Gallery extends Liquory_Base_Widgets {
    ...
    public function get_title() {
        return esc_html__('Liquory Image Gallery', 'liquory');
    }

    public function get_script_depends() {
        return [
            'isotope',
            'liquory-elementor-image-gallery'
        ];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_gallery',
            [
                'label' => esc_html__('Image Gallery', 'liquory'),
            ]
        );
        ...
        $repeater->add_control(
            'filter_title',
            [
                'label'       => esc_html__('Filter Title', 'liquory'),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => esc_html__('List Item', 'liquory'),
        ...
        $repeater->add_control(
            'wp_gallery',
            [
                'label'      => esc_html__('Add Images', 'liquory'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'filter_title' => esc_html__('Gallery 1', 'liquory'),
                    ],
                ],
        ...
        $this->add_control(
            'show_filter_bar',
            [
                'label'     => esc_html__('Filter Bar', 'liquory'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Viewpor', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => esc_html__('Off', 'liquory'),
                'label_on'  => esc_html__('On', 'liquory'),
                'condition' => [
        ...
        $this->add_responsive_control(
            'filter_item_spacing',
            [
                'label'     => esc_html__('Space Between', 'liquory'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'filter_padding',
            [
                'label'      => esc_html__('Filter Padding', 'liquory'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
                'range'      => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'image_top',
            [
                'label'      => esc_html__('To Top', 'liquory'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 100,
    ...
    protected function render() {
        ...
        if ($settings['enable_carousel'] === 'yes' && $settings['show_filter_bar'] == false) {
            ...
            if ($settings['section_design_viewport'] && $settings['section_design_viewport'] === 'yes') {
                ...
                $this->add_render_attribute('row_viewport', 'class', 'liquory-carousel-viewport');
            }
        ...
        if ($settings['show_filter_bar'] == 'yes') {
            ...
            <ul class="elementor-galerry__filters"
                ...
                <li class="elementor-galerry__filter elementor-active"
                    data-filter=".masonry-item__all"><?php echo esc_html__('All', 'liquory'); ?>
        ...
        <div class="elementor-opal-image-gallery">
            ...
            <div <?php echo liquory_elementor_get_render_attribute_string('row', $this) ?>>
                ...
                foreach ($image_gallery as $index => $item) {
                    ...
                    <div class="column-item grid__item masonry-item__all <?php echo 'gallery_group_' . esc_attr($item['group']); ?>">
                        <a data-elementor-open-lightbox="yes" <?php echo liquory_elementor_get_render_attribute_string('link', $this); ?>
            ...
            <?php if ($settings['section_design_viewport'] && $settings['section_design_viewport'] === 'yes'): ?>
                <div <?php echo liquory_elementor_get_render_attribute_string('row_viewport', $this) ?>>
...
$widgets_manager->register(new Liquory_Elementor_Image_Gallery());
