 ...
 * @since 1.0.0
 */
class Liquory_Elementor_Brand extends Liquory_Base_Widgets {
    ...
    public function get_title() {
        return esc_html__('Brands', 'liquory');
    }
    ...
    public function get_script_depends() {
        return ['liquory-elementor-brand', 'slick'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_brands',
            [
                'label' => esc_html__('Brands', 'liquory'),
            ]
        );
        ...
        $repeater->add_control(
            'brand_title',
            [
                'label'       => esc_html__('Brand name', 'liquory'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Brand Name', 'liquory'),
                'placeholder' => esc_html__('Brand Name', 'liquory'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_responsive_control(
            'brand_source',
            [
                'label'   => esc_html__('Brand Source', 'liquory'),
                'type'    => \Elementor\Controls_Manager::SELECT,
                'default' => 'image',
                'options' => [
                    'image' => esc_html__('Image', 'liquory'),
                    'icon'  => esc_html__('Icon', 'liquory')
                ],
            ]
        );
        ...
        $this->add_control(
            'heading_settings',
            [
                'label'     => esc_html__('Settings', 'liquory'),
        ...
        $this->start_controls_section(
            'style_brand_wrapper',
            [
                'label' => esc_html__('Brand Item', 'liquory'),
        ...
        $this->start_controls_section(
            'section_image',
            [
                'label' => esc_html__('Image Style', 'liquory'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'show_border',
            [
                'label'        => esc_html__('Enable Border', 'liquory'),
                        ...
                        <div <?php echo liquory_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <div class="elementor-brand-image">
                                ...
                                if (!empty($item['link'])) {
                                    ...
                                    echo '<a href="' . esc_url($item['link']['url'] ? $item['link']['url'] : '#') . '" ' . liquory_elementor_get_render_attribute_string('brand-image', $this) . ' title="' . esc_attr($item['brand_title']) . '">';
                                }
...
$widgets_manager->register(new Liquory_Elementor_Brand());
