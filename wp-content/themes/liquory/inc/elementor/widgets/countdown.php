...
class Liquory_Elementor_Countdown extends Elementor\Widget_Base {

    public function get_name() {
        return 'liquory-countdown';
    }

    public function get_title() {
        return esc_html__('liquory Countdown', 'liquory');
    }
    ...
    public function get_script_depends() {
        return ['liquory-elementor-countdown'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_countdown',
            [
                'label' => esc_html__('Countdown', 'liquory'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options'      => [
                    'style-1' => esc_html__('Style 1', 'liquory'),
                    'style-2' => esc_html__('Style 2', 'liquory'),
                    'style-3' => esc_html__('Style 3', 'liquory'),
                    'style-4' => esc_html__('Style 4', 'liquory'),
                ],
                'default'      => 'style-1',
        ...
        $this->add_control(
            'due_date',
            [
                'label'       => esc_html__('Due Date', 'liquory'),
                'type'        => Controls_Manager::DATE_TIME,
                'default'     => date('Y-m-d H:i', strtotime('+1 month') + (get_option('gmt_offset') * HOUR_IN_SECONDS)),
                /* translators: %s: Time zone. */
                'description' => sprintf(esc_html__('Date set according to your timezone: %s.', 'liquory'), Utils::get_timezone_string()),
            ]
        );
        ...
        $this->add_control(
            'show_hours',
            [
                'label'     => esc_html__('Hours', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'liquory'),
                'label_off' => esc_html__('Hide', 'liquory'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'show_minutes',
            [
                'label'     => esc_html__('Minutes', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'liquory'),
                'label_off' => esc_html__('Hide', 'liquory'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'show_seconds',
            [
                'label'     => esc_html__('Seconds', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'liquory'),
                'label_off' => esc_html__('Hide', 'liquory'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'show_labels',
            [
                'label'     => esc_html__('Show Label', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'liquory'),
                'label_off' => esc_html__('Hide', 'liquory'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'custom_labels',
            [
                'label'     => esc_html__('Custom Label', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'condition' => [
                    'show_labels!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Days', 'liquory'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Days', 'liquory'),
                'placeholder' => esc_html__('Days', 'liquory'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_days'      => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Hours', 'liquory'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Hours', 'liquory'),
                'placeholder' => esc_html__('Hours', 'liquory'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_hours'     => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Minutes', 'liquory'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Minutes', 'liquory'),
                'placeholder' => esc_html__('Minutes', 'liquory'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_minutes'   => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Seconds', 'liquory'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Seconds', 'liquory'),
                'placeholder' => esc_html__('Seconds', 'liquory'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_seconds'   => 'yes',
        ...
        $this->start_controls_section(
            'section_box_style',
            [
                'label' => esc_html__('Boxes', 'liquory'),
        ...
        $this->add_responsive_control(
            'container_width',
            [
                'label'      => esc_html__('Container Width', 'liquory'),
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .elementor-liquory-countdown' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'items_width',
            [
                'label'      => esc_html__('Items Width', 'liquory'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'items_height',
            [
                'label'      => esc_html__('Items Height', 'liquory'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}}.elementor-widget-liquory-countdown .elementor-countdown-item:before' => 'right: -{{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default'   => 'center',
                'selectors' => [
                    '{{WRAPPER}} .elementor-liquory-countdown' => 'justify-content: {{VALUE}}',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Digits', 'liquory'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            'section_label_style',
            [
                'label' => esc_html__('Label', 'liquory'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            'section_inner_style',
            [
                'label' => esc_html__('Inner', 'liquory'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
    ...
    private function _init_default_countdown_labels() {
        $this->_default_countdown_labels = [
            'label_months'  => esc_html__('Months', 'liquory'),
            'label_weeks'   => esc_html__('Weeks', 'liquory'),
            'label_days'    => esc_html__('Days', 'liquory'),
            'label_hours'   => esc_html__('Hrs', 'liquory'),
            'label_minutes' => esc_html__('Mins', 'liquory'),
            'label_seconds' => esc_html__('Secs', 'liquory'),
        ];
    }
    ...
    protected function render() {
        ...
        <div class="countdown-inner">
            ...
            <?php endif; ?>
            <div class="elementor-liquory-countdown" data-date="<?php echo esc_attr($due_date); ?>">
                <?php echo liquory_elementor_get_strftime($instance, $this); // WPCS: XSS ok. ?>
            </div>
        </div>
        <?php
    }
...
$widgets_manager->register(new Liquory_Elementor_Countdown());
