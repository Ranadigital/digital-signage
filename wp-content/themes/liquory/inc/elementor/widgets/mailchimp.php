...
if (!liquory_is_mailchimp_activated()) {
    return;
}
...
class Liquory_Elementor_Mailchimp extends Elementor\Widget_Base
{

    public function get_name()
    {
        return 'liquory-mailchmip';
    }

    public function get_title()
    {
        return esc_html__('MailChimp Sign-Up Form', 'liquory');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Input', 'liquory'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Placeholder', 'liquory'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab(
            'tab_input_focus',
            [
                'label' => esc_html__('Focus', 'liquory'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon Border Color hover', 'liquory'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
...
$widgets_manager->register(new Liquory_Elementor_Mailchimp());
