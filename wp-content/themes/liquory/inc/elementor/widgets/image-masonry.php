 ...
 * @since 1.0.0
 */
class Liquory_Elementor_Image_Masonry extends Liquory_Base_Widgets {
    ...
    public function get_title() {
        return esc_html__('Liquory Image Masonry', 'liquory');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_masonry',
            [
                'label' => esc_html__('Image Masonry', 'liquory'),
            ]
        );
...
$widgets_manager->register(new Liquory_Elementor_Image_Masonry());
