 ...
 * @since 1.0.0
 */
class Liquory_Elementor_Widget_Products extends Liquory_Base_Widgets {
    ...
    public function get_title() {
        return esc_html__('Products', 'liquory');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'ids'          => esc_html__('Product Name', 'liquory'),
                ],
            ]
        );
        ...
        $this->add_control(
            'paginate',
            [
                'label'   => esc_html__('Paginate', 'liquory'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'none',
                'options' => [
                    'none'       => esc_html__('None', 'liquory'),
                    'pagination' => esc_html__('Pagination', 'liquory'),
                ],
            ]
        );
        ...
        $this->add_control(
            'show_time_sale',
            [
                'label'     => esc_html__('Show Time Sale', 'liquory'),
        ...
        $this->add_control(
            'show_deal_sold',
            [
                'label'     => esc_html__('Show Deal Sold', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'condition' => [
                    'product_type'   => 'on_sale',
                    'product_layout' => 'grid'
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Products', 'liquory'),
...
$widgets_manager->register(new Liquory_Elementor_Widget_Products());
