...
/**
 * Elementor Liquory_Elementor_Products_Categories
 * @since 1.0.0
 */
class Liquory_Elementor_Products_Categories extends Liquory_Base_Widgets {
    ...
    public function get_name() {
        return 'liquory-product-categories';
    }
    ...
    public function get_title() {
        return esc_html__('Liquory Product Categories', 'liquory');
    }
    ...
    public function get_script_depends() {
        return ['liquory-elementor-product-categories', 'slick'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'categories_name',
            [
                'label' => esc_html__('Alternate Name', 'liquory'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '1',
                'options' => [
                    '1' => esc_html__('Layout 1', 'liquory'),
                    '2' => esc_html__('Layout 2', 'liquory'),
                    '3' => esc_html__('Layout 3', 'liquory'),
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .liquory-carousel .column-item'        => 'padding-left: calc({{SIZE}}{{UNIT}} / 2); padding-right: calc({{SIZE}}{{UNIT}} / 2);',
        ...
        $this->add_control(
            'box_opacity',
            [
                'label'     => esc_html__('Opacity', 'liquory'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max'  => 1,
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'    => [
                    '{{WRAPPER}} .category-product-img:after' => 'display: none',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'image_object_fit',
            [
                'label'     => esc_html__('Object Fit', 'liquory'),
                'type'      => Controls_Manager::SELECT,
                'condition' => [
                    'image_height[size]!' => '',
                ],
                'options'   => [
                    ''        => esc_html__('Default', 'liquory'),
                    'fill'    => esc_html__('Fill', 'liquory'),
                    'cover'   => esc_html__('Cover', 'liquory'),
                    'contain' => esc_html__('Contain', 'liquory'),
                ],
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .row:not(.layout-1) .product-cat.category-product-img ' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .row:not(.layout-1) .product-cat:hover .category-product-img ' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'title_color_hover',
            [
                'label'     => esc_html__('Hover Color', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            'total_style',
            [
                'label' => esc_html__('Total', 'liquory'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'total_color_text',
            [
                'label'     => esc_html__('Color Text', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'total_color',
            [
                'label'     => esc_html__('Color Count', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
                    ...
                    <?php foreach ($settings['categories_list'] as $index => $item): ?>
                        ...
                        <div <?php echo liquory_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <?php if (empty($item['categories'])) {
                                echo esc_html__('Choose Category', 'liquory');
                                return;
                            }
                                       ...
                                       title="<?php echo esc_attr($category->name); ?>">
                                        <?php if ($settings['product_cate_layout'] == '1'): ?>
                                            ...
                                            <div class="product-cat-caption">
                                                <div class="cat-title">
                                                    <span class="title"><?php echo empty($item['categories_name']) ? esc_html($category->name) : sprintf('%s', $item['categories_name']); ?> </span><span class="count"><?php echo esc_html($category->count); ?></span>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        <?php if ($settings['product_cate_layout'] == '2'): ?>
                                            ...
                                            <div class="product-cat-caption">
                                                ...
                                                <div class="cat-total">
                                                    ...
                                                    <span class="text"><?php echo esc_html__('products', 'liquory'); ?></span>
                                                </div>
...
$widgets_manager->register(new Liquory_Elementor_Products_Categories());
