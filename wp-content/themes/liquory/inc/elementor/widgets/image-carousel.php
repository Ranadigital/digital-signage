...
class Liquory_Elementor_Image_Carousel extends Liquory_Base_Widgets {
    ...
    public function get_title() {
        return esc_html__('Liquory Image Carousel', 'liquory');
    }
    ...
    public function get_script_depends() {
        return ['liquory-elementor-image-carousel', 'slick'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'target_link',
            [
                'label'   => esc_html__('Target', 'liquory'),
                'default' => 'yes',
...
$widgets_manager->register(new Liquory_Elementor_Image_Carousel());
