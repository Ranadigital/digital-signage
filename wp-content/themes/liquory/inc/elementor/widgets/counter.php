...
class Liquory_Elementor_Counter extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Liquory Counter', 'liquory');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'starting_number',
            [
                'label'   => __('Starting Number', 'liquory'),
        ...
        $this->add_control(
            'ending_number',
            [
                'label'   => __('Ending Number', 'liquory'),
                'type'    => Controls_Manager::NUMBER,
                'default' => 100,
            ]
        );
        ...
        $this->add_control(
            'prefix',
            [
                'label'       => __('Number Prefix', 'liquory'),
        ...
        $this->add_control(
            'suffix',
            [
                'label'       => __('Number Suffix', 'liquory'),
                'type'        => Controls_Manager::TEXT,
                'default'     => '',
                'placeholder' => __('Plus', 'liquory'),
            ]
        );
        ...
        $this->add_control(
            'show_icon',
            [
                'label'     => __('Show Icon', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => __('Show', 'liquory'),
                'label_off' => __('Hide', 'liquory'),
            ]
        );
        ...
        $this->add_control(
            'icon_select',
            [
                'label'     => __('Icon select', 'liquory'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'use_icon',
                'options'   => [
                    'use_icon'  => __('Use Icon', 'liquory'),
                    'use_image' => __('Use Image', 'liquory'),
                ],
                'condition' => [
                    'show_icon' => 'yes',
                ],
        ...
        $this->add_control(
            'duration',
            [
                'label'   => __('Animation Duration', 'liquory'),
                'type'    => Controls_Manager::NUMBER,
                'default' => 2000,
                'min'     => 100,
                'step'    => 100,
        ...
        $this->add_control(
            'thousand_separator',
            [
                'label'     => __('Thousand Separator', 'liquory'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'label_on'  => __('Show', 'liquory'),
                'label_off' => __('Hide', 'liquory'),
        ...
        $this->add_control(
            'title',
            [
                'label'       => __('Title', 'liquory'),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'default'     => __('Cool Number', 'liquory'),
                'placeholder' => __('Cool Number', 'liquory'),
            ]
        );
        ...
        $this->add_control(
            'sub_title',
            [
                'label'       => __('Sub Title', 'liquory'),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __('Sub Title', 'liquory'),
            ]
        );
        ...
        $this->add_control(
            'description',
            [
                'label'       => __('Description', 'liquory'),
                'type'        => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'placeholder' => __('Description...', 'liquory'),
            ]
        );
        ...
        $this->add_control(
            'style_special2',
            [
                'label'        => esc_html__('Style border special', 'liquory'),
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Vertical Alignment', 'liquory'),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    'top'      => __('Top', 'liquory'),
                    'middle'   => __('Middle', 'liquory'),
                    'bottom'   => __('Bottom', 'liquory'),
                ],
                'default'      => 'top',
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Background Color Hover', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'border_color_effect',
            [
                'label'     => esc_html__('Border Color Effect', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'width_box_effect',
            [
                'label' => esc_html__( 'Width Box Effect', 'liquory' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 100,
        ...
        $this->add_control(
            'number_color_hover',
            [
                'label'     => __('Text Color Hover', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Background Color', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Background Color Hover', 'liquory'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
            ...
            <div class="elementor-icon-counter">
                <?php if ('use_image' === $settings['icon_select'] && !empty($settings['image']['url'])) :
                    ...
                    if ($path_parts['extension'] === 'svg') {
                        ...
                        $image_html = liquory_get_icon_svg($pathSvg);
                    }
...
$widgets_manager->register(new Liquory_Elementor_Counter());
