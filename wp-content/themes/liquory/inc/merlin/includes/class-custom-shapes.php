...
/**
 * Class Liquory_Elementor_Custom_Shapes
 *
 * Main Plugin class
 * @since 0.0.1
 */
class Liquory_Elementor_Custom_Shapes {
    ...
    public function ecs_register_cpt() {
        ...
        $labels = array(
            'name'                  => _x('Custom shapes', 'Post Type General Name', 'liquory'),
            'singular_name'         => _x('Custom shape', 'Post Type Singular Name', 'liquory'),
            'menu_name'             => __('Custom shapes', 'liquory'),
            'name_admin_bar'        => __('Custom shape', 'liquory'),
            'archives'              => __('Item Archives', 'liquory'),
            'attributes'            => __('Item Attributes', 'liquory'),
            'parent_item_colon'     => __('Parent Item:', 'liquory'),
            'all_items'             => __('All Items', 'liquory'),
            'add_new_item'          => __('Add New Item', 'liquory'),
            'add_new'               => __('Add New', 'liquory'),
            'new_item'              => __('New Item', 'liquory'),
            'edit_item'             => __('Edit Item', 'liquory'),
            'update_item'           => __('Update Item', 'liquory'),
            'view_item'             => __('View Item', 'liquory'),
            'view_items'            => __('View Items', 'liquory'),
            'search_items'          => __('Search Item', 'liquory'),
            'not_found'             => __('Not found', 'liquory'),
            'not_found_in_trash'    => __('Not found in Trash', 'liquory'),
            'featured_image'        => __('Featured Image', 'liquory'),
            'set_featured_image'    => __('Set featured image', 'liquory'),
            'remove_featured_image' => __('Remove featured image', 'liquory'),
            'use_featured_image'    => __('Use as featured image', 'liquory'),
            'insert_into_item'      => __('Insert into item', 'liquory'),
            'uploaded_to_this_item' => __('Uploaded to this item', 'liquory'),
            'items_list'            => __('Items list', 'liquory'),
            'items_list_navigation' => __('Items list navigation', 'liquory'),
            'filter_items_list'     => __('Filter items list', 'liquory'),
        );
        $args   = array(
            'label'               => __('Custom shape', 'liquory'),
            'description'         => __('Custom shapes', 'liquory'),
            'labels'              => $labels,
    ...
    public function ecs_register_admin_menu() {
        $menu_title = _x('Custom Shapes', 'Elementor Custom Shapes', 'liquory');
        add_submenu_page(
            'elementor',
            $menu_title,
            $menu_title,
...
Liquory_Elementor_Custom_Shapes::instance();